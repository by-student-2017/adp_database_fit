...
def f(x):
  ...
  # u
  text = text.replace('urhoe1',str(x[22]).replace("[","").replace("]",""))
  text = text.replace('urhoe2',str(x[23]).replace("[","").replace("]",""))
  text = text.replace('un0',str(x[24]).replace("[","").replace("]",""))
  text = text.replace('un1',str(x[25]).replace("[","").replace("]",""))
  text = text.replace('un2',str(x[26]).replace("[","").replace("]",""))
  text = text.replace('un3',str(x[27]).replace("[","").replace("]",""))
  text = text.replace('u0',str(x[28]).replace("[","").replace("]",""))
  text = text.replace('u1',str(x[29]).replace("[","").replace("]",""))
  text = text.replace('u2',str(x[30]).replace("[","").replace("]",""))
  text = text.replace('u3',str(x[31]).replace("[","").replace("]",""))
  text = text.replace('u4',str(x[32]).replace("[","").replace("]",""))
  ...
  # w
  text = text.replace('wrhoe1',str(x[37]).replace("[","").replace("]",""))
  text = text.replace('wrhoe2',str(x[38]).replace("[","").replace("]",""))
  text = text.replace('wn0',str(x[39]).replace("[","").replace("]",""))
  text = text.replace('wn1',str(x[40]).replace("[","").replace("]",""))
  text = text.replace('wn2',str(x[41]).replace("[","").replace("]",""))
  text = text.replace('wn3',str(x[42]).replace("[","").replace("]",""))
  text = text.replace('w0',str(x[43]).replace("[","").replace("]",""))
  text = text.replace('w1',str(x[44]).replace("[","").replace("]",""))
  text = text.replace('w2',str(x[45]).replace("[","").replace("]",""))
  text = text.replace('w3',str(x[46]).replace("[","").replace("]",""))
  text = text.replace('w4',str(x[47]).replace("[","").replace("]",""))
