...
commands.getoutput("cp ./data/data.in.HCP data.in_273K")
...
# u
x22 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+27){print $1}}' ADP_code.init | head -1"))
x23 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+28){print $1}}' ADP_code.init | head -1"))
x24 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+29){print $1}}' ADP_code.init | head -1"))
x25 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+30){print $1}}' ADP_code.init | head -1"))
x26 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+31){print $1}}' ADP_code.init | head -1"))
x27 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+32){print $1}}' ADP_code.init | head -1"))
x28 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+33){print $1}}' ADP_code.init | head -1"))
x29 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+34){print $1}}' ADP_code.init | head -1"))
x30 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+35){print $1}}' ADP_code.init | head -1"))
x31 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+36){print $1}}' ADP_code.init | head -1"))
x32 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+37){print $1}}' ADP_code.init | head -1"))
x33 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+38){print $1}}' ADP_code.init | head -1"))
x34 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+39){print $1}}' ADP_code.init | head -1"))
x35 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+40){print $1}}' ADP_code.init | head -1"))
x36 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+41){print $1}}' ADP_code.init | head -1"))
# w
x37 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+42){print $1}}' ADP_code.init | head -1"))
x38 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+43){print $1}}' ADP_code.init | head -1"))
x39 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+44){print $1}}' ADP_code.init | head -1"))
x40 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+45){print $1}}' ADP_code.init | head -1"))
x41 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+46){print $1}}' ADP_code.init | head -1"))
x42 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+47){print $1}}' ADP_code.init | head -1"))
x43 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+48){print $1}}' ADP_code.init | head -1"))
x44 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+49){print $1}}' ADP_code.init | head -1"))
x45 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+50){print $1}}' ADP_code.init | head -1"))
x46 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+51){print $1}}' ADP_code.init | head -1"))
x47 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+52){print $1}}' ADP_code.init | head -1"))
x48 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+53){print $1}}' ADP_code.init | head -1"))
x49 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+54){print $1}}' ADP_code.init | head -1"))
x50 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+55){print $1}}' ADP_code.init | head -1"))
x51 = float(commands.getoutput("awk '{if(NR=="+str(nline)+"+56){print $1}}' ADP_code.init | head -1"))
...
def evalOneMax(individual):
  ...
  # u
  text = text.replace('urhoe1',str(individual[22]).replace("[","").replace("]",""))
  text = text.replace('urhoe2',str(individual[23]).replace("[","").replace("]",""))
  text = text.replace('un0',str(individual[24]).replace("[","").replace("]",""))
  text = text.replace('un1',str(individual[25]).replace("[","").replace("]",""))
  text = text.replace('un2',str(individual[26]).replace("[","").replace("]",""))
  text = text.replace('un3',str(individual[27]).replace("[","").replace("]",""))
  text = text.replace('u0',str(individual[28]).replace("[","").replace("]",""))
  text = text.replace('u1',str(individual[29]).replace("[","").replace("]",""))
  text = text.replace('u2',str(individual[30]).replace("[","").replace("]",""))
  text = text.replace('u3',str(individual[31]).replace("[","").replace("]",""))
  text = text.replace('u4',str(individual[32]).replace("[","").replace("]",""))
  ...
  # w
  text = text.replace('wrhoe1',str(individual[37]).replace("[","").replace("]",""))
  text = text.replace('wrhoe2',str(individual[38]).replace("[","").replace("]",""))
  text = text.replace('wn0',str(individual[39]).replace("[","").replace("]",""))
  text = text.replace('wn1',str(individual[40]).replace("[","").replace("]",""))
  text = text.replace('wn2',str(individual[41]).replace("[","").replace("]",""))
  text = text.replace('wn3',str(individual[42]).replace("[","").replace("]",""))
  text = text.replace('w0',str(individual[43]).replace("[","").replace("]",""))
  text = text.replace('w1',str(individual[44]).replace("[","").replace("]",""))
  text = text.replace('w2',str(individual[45]).replace("[","").replace("]",""))
  text = text.replace('w3',str(individual[46]).replace("[","").replace("]",""))
  text = text.replace('w4',str(individual[47]).replace("[","").replace("]",""))
