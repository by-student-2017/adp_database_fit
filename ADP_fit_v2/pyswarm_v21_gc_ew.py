...
print "  In the first time, need to command 'gfortran Zhou04_create_adp_v21.f -o Zhou04_ADP_v21'"
print "this code does not recommend element < Al"
print "all u parameters = 0.0"
print " "
#----------------------------------------------------------------------
file_tmp = 'ADP_code_v21.tmp'
file_tmp_ew = 'ADP_code_ew_v21.tmp'
...
# u
fi0 = open(file_tmp,'r')
text0 = fi0.read().replace('urhoe',str(x30).replace("[","").replace("]",""))
text0 = text0.replace('ui0',str(x31).replace("[","").replace("]",""))
text0 = text0.replace('ui1',str(x32).replace("[","").replace("]",""))
text0 = text0.replace('ui2',str(x33).replace("[","").replace("]",""))
text0 = text0.replace('ui3',str(x34).replace("[","").replace("]",""))
text0 = text0.replace('ui4',str(x35).replace("[","").replace("]",""))
text0 = text0.replace('ui5',str(x36).replace("[","").replace("]",""))
text0 = text0.replace('ui6',str(x37).replace("[","").replace("]",""))
text0 = text0.replace('um2',str(x38).replace("[","").replace("]",""))
text0 = text0.replace('um3',str(x39).replace("[","").replace("]",""))
text0 = text0.replace('um4',str(x40).replace("[","").replace("]",""))
text0 = text0.replace('um5',str(x41).replace("[","").replace("]",""))
text0 = text0.replace('um6',str(x42).replace("[","").replace("]",""))
text0 = text0.replace('un0',str(x43).replace("[","").replace("]",""))
text0 = text0.replace('un1',str(x44).replace("[","").replace("]",""))
text0 = text0.replace('un2',str(x45).replace("[","").replace("]",""))
text0 = text0.replace('un3',str(x46).replace("[","").replace("]",""))
text0 = text0.replace('urhol',str(x47).replace("[","").replace("]",""))
text0 = text0.replace('urhoh',str(x48).replace("[","").replace("]",""))
...
def example_fitness( individual ):
  ...
  # w
  text = text.replace('wrhoe',str(individual[30]).replace("[","").replace("]",""))
  text = text.replace('wi0',str(individual[31]).replace("[","").replace("]",""))
  text = text.replace('wi1',str(individual[32]).replace("[","").replace("]",""))
  text = text.replace('wi2',str(individual[33]).replace("[","").replace("]",""))
  text = text.replace('wi3',str(individual[34]).replace("[","").replace("]",""))
  text = text.replace('wi4',str(individual[35]).replace("[","").replace("]",""))
  text = text.replace('wi5',str(individual[36]).replace("[","").replace("]",""))
  text = text.replace('wi6',str(individual[37]).replace("[","").replace("]",""))
  text = text.replace('wm2',str(individual[38]).replace("[","").replace("]",""))
  text = text.replace('wm3',str(individual[39]).replace("[","").replace("]",""))
  text = text.replace('wm4',str(individual[40]).replace("[","").replace("]",""))
  text = text.replace('wm5',str(individual[41]).replace("[","").replace("]",""))
  text = text.replace('wm6',str(individual[42]).replace("[","").replace("]",""))
  text = text.replace('wn0',str(individual[43]).replace("[","").replace("]",""))
  text = text.replace('wn1',str(individual[44]).replace("[","").replace("]",""))
  text = text.replace('wn2',str(individual[45]).replace("[","").replace("]",""))
  text = text.replace('wn3',str(individual[46]).replace("[","").replace("]",""))
  text = text.replace('wrhol',str(individual[47]).replace("[","").replace("]",""))
  text = text.replace('wrhoh',str(individual[48]).replace("[","").replace("]",""))
  fi.close
