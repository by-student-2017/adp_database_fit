...
def f(z):
  ...
  # w
  text = text.replace('wrhoe',str(z[30]).replace("[","").replace("]",""))
  text = text.replace('wi0',str(z[31]).replace("[","").replace("]",""))
  text = text.replace('wi1',str(z[32]).replace("[","").replace("]",""))
  text = text.replace('wi2',str(z[33]).replace("[","").replace("]",""))
  text = text.replace('wi3',str(z[34]).replace("[","").replace("]",""))
  text = text.replace('wi4',str(z[35]).replace("[","").replace("]",""))
  text = text.replace('wi5',str(z[36]).replace("[","").replace("]",""))
  text = text.replace('wi6',str(z[37]).replace("[","").replace("]",""))
  text = text.replace('wm2',str(z[38]).replace("[","").replace("]",""))
  text = text.replace('wm3',str(z[39]).replace("[","").replace("]",""))
  text = text.replace('wm4',str(z[40]).replace("[","").replace("]",""))
  text = text.replace('wm5',str(z[41]).replace("[","").replace("]",""))
  text = text.replace('wm6',str(z[42]).replace("[","").replace("]",""))
  text = text.replace('wn0',str(z[43]).replace("[","").replace("]",""))
  text = text.replace('wn1',str(z[44]).replace("[","").replace("]",""))
  text = text.replace('wn2',str(z[45]).replace("[","").replace("]",""))
  text = text.replace('wn3',str(z[46]).replace("[","").replace("]",""))
  text = text.replace('wrhol',str(z[47]).replace("[","").replace("]",""))
  text = text.replace('wrhoh',str(z[48]).replace("[","").replace("]",""))
  fi.close
  ...
  print "Evaluate: ", y
  #print "Parameters: ", x
  print "Parameters: z0 = "+"[ "+str(z[0])+","+str(z[1])+","+str(z[2])+","+str(z[3])+","+str(z[4])+","+str(z[5])+","+str(z[6])+","+str(z[7])+","+str(z[8])+","+str(z[9])+","+str(z[10])+","+str(z[11])+","+str(z[12])+","+str(z[13])+","+str(z[14])+","+str(z[15])+","+str(z[16])+","+str(z[17])+","+str(z[18])+","+str(z[19])+","+str(z[20])+","+str(z[21])+","+str(z[22])+","+str(z[23])+","+str(z[24])+","+str(z[25])+","+str(z[26])+","+str(z[27])+","+str(z[28])+","+str(z[29])+","+str(z[30])+","+str(z[31])+","+str(z[32])+","+str(z[33])+","+str(z[34])+","+str(z[35])+","+str(z[36])+","+str(z[37])+","+str(z[38])+","+str(z[39])+","+str(z[40])+","+str(z[41])+","+str(z[42])+","+str(z[43])+","+str(z[44])+","+str(z[45])+","+str(z[46])+","+str(z[47])+","+str(z[48])+" ]"
  print "------------------------"
