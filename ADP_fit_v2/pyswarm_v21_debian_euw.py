...
def example_fitness( individual ):
  ...
  text = text.replace('he',str(individual[28]).replace("[","").replace("]",""))
  text = text.replace('Frhol',str(individual[29]).replace("[","").replace("]",""))
  # u
  text = text.replace('urhoe',str(individual[30]).replace("[","").replace("]",""))
  text = text.replace('ui0',str(individual[31]).replace("[","").replace("]",""))
  text = text.replace('ui1',str(individual[32]).replace("[","").replace("]",""))
  text = text.replace('ui2',str(individual[33]).replace("[","").replace("]",""))
  text = text.replace('ui3',str(individual[34]).replace("[","").replace("]",""))
  text = text.replace('ui4',str(individual[35]).replace("[","").replace("]",""))
  text = text.replace('ui5',str(individual[36]).replace("[","").replace("]",""))
  text = text.replace('ui6',str(individual[37]).replace("[","").replace("]",""))
  text = text.replace('um2',str(individual[38]).replace("[","").replace("]",""))
  text = text.replace('um3',str(individual[39]).replace("[","").replace("]",""))
  text = text.replace('um4',str(individual[40]).replace("[","").replace("]",""))
  text = text.replace('um5',str(individual[41]).replace("[","").replace("]",""))
  text = text.replace('um6',str(individual[42]).replace("[","").replace("]",""))
  text = text.replace('un0',str(individual[43]).replace("[","").replace("]",""))
  text = text.replace('un1',str(individual[44]).replace("[","").replace("]",""))
  text = text.replace('un2',str(individual[45]).replace("[","").replace("]",""))
  text = text.replace('un3',str(individual[46]).replace("[","").replace("]",""))
  text = text.replace('urhol',str(individual[47]).replace("[","").replace("]",""))
  text = text.replace('urhoh',str(individual[48]).replace("[","").replace("]",""))
  # w
  text = text.replace('wrhoe',str(individual[49]).replace("[","").replace("]",""))
  text = text.replace('wi0',str(individual[50]).replace("[","").replace("]",""))
  text = text.replace('wi1',str(individual[51]).replace("[","").replace("]",""))
  text = text.replace('wi2',str(individual[52]).replace("[","").replace("]",""))
  text = text.replace('wi3',str(individual[53]).replace("[","").replace("]",""))
  text = text.replace('wi4',str(individual[54]).replace("[","").replace("]",""))
  text = text.replace('wi5',str(individual[55]).replace("[","").replace("]",""))
  text = text.replace('wi6',str(individual[56]).replace("[","").replace("]",""))
  text = text.replace('wm2',str(individual[57]).replace("[","").replace("]",""))
  text = text.replace('wm3',str(individual[58]).replace("[","").replace("]",""))
  text = text.replace('wm4',str(individual[59]).replace("[","").replace("]",""))
  text = text.replace('wm5',str(individual[60]).replace("[","").replace("]",""))
  text = text.replace('wm6',str(individual[61]).replace("[","").replace("]",""))
  text = text.replace('wn0',str(individual[62]).replace("[","").replace("]",""))
  text = text.replace('wn1',str(individual[63]).replace("[","").replace("]",""))
  text = text.replace('wn2',str(individual[64]).replace("[","").replace("]",""))
  text = text.replace('wn3',str(individual[65]).replace("[","").replace("]",""))
  text = text.replace('wrhol',str(individual[66]).replace("[","").replace("]",""))
  text = text.replace('wrhoh',str(individual[67]).replace("[","").replace("]",""))
  fi.close
  ...
  for t in temp:
    ...
    if error_flag1 != "" and error_flag2 == "" and error_flag3 == "":
      ...
      tdiffea = 99999.99999 + sum(map(lambda x: x**2, individual))
      tdiffp  = 99999.99999 + sum(map(lambda x: x**2, individual))
      tdifff  = 99999.99999 + sum(map(lambda x: x**2, individual))
  ...
  print "Evaluate: ", y
  #print "Parameters: ", x
  print "Parameters: x = "+"[ "+str(individual[0])+","+str(individual[1])+","+str(individual[2])+","+str(individual[3])+","+str(individual[4])+","+str(individual[5])+","+str(individual[6])+","+str(individual[7])+","+str(individual[8])+","+str(individual[9])+","+str(individual[10])+","+str(individual[11])+","+str(individual[12])+","+str(individual[13])+","+str(individual[14])+","+str(individual[15])+","+str(individual[16])+","+str(individual[17])+","+str(individual[18])+","+str(individual[19])+","+str(individual[20])+","+str(individual[21])+","+str(individual[22])+","+str(individual[23])+","+str(individual[24])+","+str(individual[25])+","+str(individual[26])+","+str(individual[27])+","+str(individual[28])+","+str(individual[29])+","+str(individual[30])+","+str(individual[31])+","+str(individual[32])+","+str(individual[33])+","+str(individual[34])+","+str(individual[35])+","+str(individual[36])+","+str(individual[37])+","+str(individual[38])+","+str(individual[39])+","+str(individual[40])+","+str(individual[41])+","+str(individual[42])+","+str(individual[43])+","+str(individual[44])+","+str(individual[45])+","+str(individual[46])+","+str(individual[47])+","+str(individual[48])+","+str(individual[49])+","+str(individual[50])+","+str(individual[51])+","+str(individual[52])+","+str(individual[53])+","+str(individual[54])+","+str(individual[55])+","+str(individual[56])+","+str(individual[57])+","+str(individual[58])+","+str(individual[59])+","+str(individual[60])+","+str(individual[61])+","+str(individual[62])+","+str(individual[63])+","+str(individual[64])+","+str(individual[65])+","+str(individual[66])+","+str(individual[67])+" ]"
  print "------------------------"
