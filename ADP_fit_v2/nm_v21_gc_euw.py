...
def f(z):
  ...
  # w
  text = text.replace('wrhoe',str(z[49]).replace("[","").replace("]",""))
  text = text.replace('wi0',str(z[50]).replace("[","").replace("]",""))
  text = text.replace('wi1',str(z[51]).replace("[","").replace("]",""))
  text = text.replace('wi2',str(z[52]).replace("[","").replace("]",""))
  text = text.replace('wi3',str(z[53]).replace("[","").replace("]",""))
  text = text.replace('wi4',str(z[54]).replace("[","").replace("]",""))
  text = text.replace('wi5',str(z[55]).replace("[","").replace("]",""))
  text = text.replace('wi6',str(z[56]).replace("[","").replace("]",""))
  text = text.replace('wm2',str(z[57]).replace("[","").replace("]",""))
  text = text.replace('wm3',str(z[58]).replace("[","").replace("]",""))
  text = text.replace('wm4',str(z[59]).replace("[","").replace("]",""))
  text = text.replace('wm5',str(z[60]).replace("[","").replace("]",""))
  text = text.replace('wm6',str(z[61]).replace("[","").replace("]",""))
  text = text.replace('wn0',str(z[62]).replace("[","").replace("]",""))
  text = text.replace('wn1',str(z[63]).replace("[","").replace("]",""))
  text = text.replace('wn2',str(z[64]).replace("[","").replace("]",""))
  text = text.replace('wn3',str(z[65]).replace("[","").replace("]",""))
  text = text.replace('wrhol',str(z[66]).replace("[","").replace("]",""))
  text = text.replace('wrhoh',str(z[67]).replace("[","").replace("]",""))
  fi.close
