...
def descripter(x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,
  ...
  # u
  text = text.replace('urhoe1',str(x22))
  text = text.replace('urhoe2',str(x23))
  text = text.replace('un0',str(x24))
  text = text.replace('un1',str(x25))
  text = text.replace('un2',str(x26))
  text = text.replace('un3',str(x27))
  text = text.replace('u0',str(x28))
  text = text.replace('u1',str(x29))
  text = text.replace('u2',str(x30))
  text = text.replace('u3',str(x31))
  text = text.replace('u4',str(x32))
  text = text.replace('ueta',str(x33))
  text = text.replace('uep',str(x34))
  text = text.replace('urhol',str(x35))
  # w
  text = text.replace('wrhoe1',str(x37))
  text = text.replace('wrhoe2',str(x38))
  text = text.replace('wn0',str(x39))
  text = text.replace('wn1',str(x40))
  text = text.replace('wn2',str(x41))
  text = text.replace('wn3',str(x42))
  text = text.replace('w0',str(x43))
  text = text.replace('w1',str(x44))
  text = text.replace('w2',str(x45))
  text = text.replace('w3',str(x46))
  text = text.replace('w4',str(x47))
...
optimizer.maximize(init_points=1, n_iter=12000, acq="ucb")
