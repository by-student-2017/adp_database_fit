...
def f(z):
  ...
  text = text.replace('Frhos',str(z[3]).replace("[","").replace("]",""))
  ...
  text = text.replace('cai',str(z[8]).replace("[","").replace("]",""))
  text = text.replace('lambda',str(z[9]).replace("[","").replace("]",""))
  text = text.replace('Fi0',str(z[10]).replace("[","").replace("]",""))
  text = text.replace('Fi1',str(z[11]).replace("[","").replace("]",""))
  text = text.replace('Fi2',str(z[12]).replace("[","").replace("]",""))
  text = text.replace('Fi3',str(z[13]).replace("[","").replace("]",""))
  text = text.replace('Fi4',str(z[14]).replace("[","").replace("]",""))
  text = text.replace('Fi5',str(z[15]).replace("[","").replace("]",""))
  text = text.replace('Fi6',str(z[16]).replace("[","").replace("]",""))
  text = text.replace('Fm2',str(z[17]).replace("[","").replace("]",""))
  text = text.replace('Fm3',str(z[18]).replace("[","").replace("]",""))
  text = text.replace('Fm4',str(z[19]).replace("[","").replace("]",""))
  text = text.replace('Fm5',str(z[20]).replace("[","").replace("]",""))
  text = text.replace('Fm6',str(z[21]).replace("[","").replace("]",""))
  text = text.replace('Fn0',str(z[22]).replace("[","").replace("]",""))
  text = text.replace('Fn1',str(z[23]).replace("[","").replace("]",""))
  ...
  # w
  text = text.replace('wrhoe',str(z[46]).replace("[","").replace("]",""))
  text = text.replace('wi0',str(z[47]).replace("[","").replace("]",""))
  text = text.replace('wi1',str(z[48]).replace("[","").replace("]",""))
  text = text.replace('wi2',str(z[49]).replace("[","").replace("]",""))
  text = text.replace('wi3',str(z[50]).replace("[","").replace("]",""))
  text = text.replace('wi4',str(z[51]).replace("[","").replace("]",""))
  text = text.replace('wi5',str(z[52]).replace("[","").replace("]",""))
  text = text.replace('wi6',str(z[53]).replace("[","").replace("]",""))
  text = text.replace('wm2',str(z[54]).replace("[","").replace("]",""))
  text = text.replace('wm3',str(z[55]).replace("[","").replace("]",""))
  text = text.replace('wm4',str(z[56]).replace("[","").replace("]",""))
  text = text.replace('wm5',str(z[57]).replace("[","").replace("]",""))
  text = text.replace('wm6',str(z[58]).replace("[","").replace("]",""))
  text = text.replace('wn0',str(z[59]).replace("[","").replace("]",""))
  text = text.replace('wn1',str(z[60]).replace("[","").replace("]",""))
  text = text.replace('wn2',str(z[61]).replace("[","").replace("]",""))
  text = text.replace('wn3',str(z[62]).replace("[","").replace("]",""))
  text = text.replace('wrhol',str(z[63]).replace("[","").replace("]",""))
  text = text.replace('wrhoh',str(z[64]).replace("[","").replace("]",""))
  fi.close
