...
def example_fitness( individual ):
  ...
  # u
  text = text.replace('urhoe',str(individual[27]).replace("[","").replace("]",""))
  text = text.replace('ui0',str(individual[28]).replace("[","").replace("]",""))
  text = text.replace('ui1',str(individual[29]).replace("[","").replace("]",""))
  text = text.replace('ui2',str(individual[30]).replace("[","").replace("]",""))
  text = text.replace('ui3',str(individual[31]).replace("[","").replace("]",""))
  text = text.replace('ui4',str(individual[32]).replace("[","").replace("]",""))
  text = text.replace('ui5',str(individual[33]).replace("[","").replace("]",""))
  text = text.replace('ui6',str(individual[34]).replace("[","").replace("]",""))
  text = text.replace('um2',str(individual[35]).replace("[","").replace("]",""))
  text = text.replace('um3',str(individual[36]).replace("[","").replace("]",""))
  text = text.replace('um4',str(individual[37]).replace("[","").replace("]",""))
  text = text.replace('um5',str(individual[38]).replace("[","").replace("]",""))
  text = text.replace('um6',str(individual[39]).replace("[","").replace("]",""))
  text = text.replace('un0',str(individual[40]).replace("[","").replace("]",""))
  text = text.replace('un1',str(individual[41]).replace("[","").replace("]",""))
  text = text.replace('un2',str(individual[42]).replace("[","").replace("]",""))
  text = text.replace('un3',str(individual[43]).replace("[","").replace("]",""))
  text = text.replace('urhol',str(individual[44]).replace("[","").replace("]",""))
  text = text.replace('urhoh',str(individual[45]).replace("[","").replace("]",""))
  # w
  text = text.replace('wrhoe',str(individual[46]).replace("[","").replace("]",""))
  text = text.replace('wi0',str(individual[47]).replace("[","").replace("]",""))
  text = text.replace('wi1',str(individual[48]).replace("[","").replace("]",""))
  text = text.replace('wi2',str(individual[49]).replace("[","").replace("]",""))
  text = text.replace('wi3',str(individual[50]).replace("[","").replace("]",""))
  text = text.replace('wi4',str(individual[51]).replace("[","").replace("]",""))
  text = text.replace('wi5',str(individual[52]).replace("[","").replace("]",""))
  text = text.replace('wi6',str(individual[53]).replace("[","").replace("]",""))
  text = text.replace('wm2',str(individual[54]).replace("[","").replace("]",""))
  text = text.replace('wm3',str(individual[55]).replace("[","").replace("]",""))
  text = text.replace('wm4',str(individual[56]).replace("[","").replace("]",""))
  text = text.replace('wm5',str(individual[57]).replace("[","").replace("]",""))
  text = text.replace('wm6',str(individual[58]).replace("[","").replace("]",""))
  text = text.replace('wn0',str(individual[59]).replace("[","").replace("]",""))
  text = text.replace('wn1',str(individual[60]).replace("[","").replace("]",""))
  text = text.replace('wn2',str(individual[61]).replace("[","").replace("]",""))
  text = text.replace('wn3',str(individual[62]).replace("[","").replace("]",""))
  text = text.replace('wrhol',str(individual[63]).replace("[","").replace("]",""))
  text = text.replace('wrhoh',str(individual[64]).replace("[","").replace("]",""))
  fi.close
